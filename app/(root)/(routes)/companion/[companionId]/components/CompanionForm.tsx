      ...
      <Form {...form}>
        ...
        >
          <div className=" space-y-2 w-full ">
            <div>
              <h3 className=" text-xl font-medium">Generator Information</h3>
                ...
                render={({ field }) => (
                  <FormItem className=" col-span-2 md:col-span-1">
                    ...
                    <FormControl>
                      <Input
                        disabled={isLoading}
                        placeholder="CEO and founder of X"
                        {...field}
                      />
                    </FormControl>
                    <FormDescription>
            ...
            <FormField
              ...
              render={({ field }) => (
                <FormItem className=" col-span-2 md:col-span-1">
                  ...
                  <FormDescription>
                    Describe in detail your companions backstory and relevant details
                  </FormDescription>
                  <FormMessage />
                </FormItem>
              )}
